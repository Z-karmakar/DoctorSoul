...
export default function UserIcon({ user, onSignOut, userIconRef }) {
   ...
   return (
      <div className="container mx-auto px-4 py-8">
         {/* User icon in header */}
         <div className="fixed top-3 right-23 z-50 hover:scale-110 transition-all duration-100 ease-in-out">
            <button
               ref={userIconRef}
