...
const Brands = ({ onBrandSelect }) => {
   ...
   return (
      <div id="brands" className="bg-gray-100 font-sans pt-20">
         <div className="container mx-auto py-10 relative">
            <h1 className="text-2xl capitalize text-center font-bold text-green-600 mb-10">
               Shop By Brand
            </h1>

            {/* Left scroll button */}
            <button
               className="absolute left-0 top-1/5 transform -translate-y-1/2 bg-green-300 text-black px-4 py-2 rounded-full shadow-lg hover:bg-green-500 z-10"
               onClick={scrollLeft}
            >
            ...
            >
               {brands.map((brand) => (
                  <div
                     key={brand.id}
                     id={brand.id}
                     className="flex-none w-64 bg-green-100 shadow-lg rounded-lg p-6 text-center transform transition duration-300 hover:bg-green-300 hover:cursor-pointer"
            ...
            {/* Right scroll button */}
            <button
               className="absolute right-0 top-1/5 transform -translate-y-1/2 bg-green-300 text-black px-4 py-2 rounded-full shadow-lg hover:bg-green-500 z-10"
               onClick={scrollRight}
            >
