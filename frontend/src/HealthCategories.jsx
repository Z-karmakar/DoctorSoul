...
const HealthCategories = ({ onCategorySelect }) => {
   ...
   return (
      <div id="categories" className="bg-gray-100 font-sans pt-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-6">
               ...
               {categories.map((category) => (
                  <div
                     key={category.id}
                     id={category.id}
                     className="bg-green-100 shadow-lg rounded-lg p-6 text-center hover:ring-2 hover:ring-green-600 hover:cursor-pointer"
