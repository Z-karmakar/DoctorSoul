...
function BrandMedicine({ brandNum, handleAddToCart }) {
   ...
   return (
      <>
         <h2 className="uppercase font-extrabold text-3xl text-green-500 m-10">
            {!brandNum && brandNum !== 0
               ? "Please Select a Brand Above To See Its Medicines"
               : allMedicines.brandsWithMedicines[brandNum].name + " Medicines..."}
         </h2>
         <Medicine medicines={medicines} handleAddToCart={handleAddToCart} />
      </>
   );
}
