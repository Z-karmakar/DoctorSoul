...
const NursePersonalInfoForm = ({ formData, handleChange, handleSubmit }) => {
   ...
   return (
      <div className="bg-white shadow-lg rounded-lg p-8 mb-10 border border-purple-100">
         <h2 className="text-xl font-semibold text-gray-800 mb-8 flex items-center">
            <User className="mr-2 text-purple-600" />
            Nurse Personal Information
         </h2>

         <form onSubmit={handleSubmit}>
            {/* Profile Photo Upload Section */}
            <div className="flex flex-col items-center justify-center mb-8">
               <div className="w-32 h-32 rounded-full bg-purple-50 flex items-center justify-center border-2 border-purple-200 overflow-hidden relative mb-3">
               ...
               <button
                  ...
                  className="px-4 py-2 bg-purple-50 text-purple-600 rounded-md flex items-center hover:bg-purple-100 transition-colors"
               >
                  ...
                  <div className="flex relative">
                     <div className="relative flex-grow">
                        <input
                           ...
                           onChange={handleChange}
                           required
                           className="w-full px-3 py-2 pl-9 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
                     ...
                     <button
                        ...
                        disabled={isLocating}
                        className="ml-2 px-3 py-2 bg-purple-50 text-purple-600 rounded-md flex items-center hover:bg-purple-100 transition-colors whitespace-nowrap"
                     >
...
export default NursePersonalInfoForm;
